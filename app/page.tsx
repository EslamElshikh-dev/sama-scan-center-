...
const faqs = [
  ...
  },
  {
    ...
    answer: `يقع ${site.nameAr} في ${site.address}. يمكنك فتح الاتجاهات المباشرة من صفحة الموقع.`,
  },
  {
      ...
      <section className="hero">
        ...
        <div className="container hero-grid">
          <div className="hero-copy reveal">
            ...
            <h1>
              <span className="hero-title-brand">مركز سما سكان للأشعة في الرياض</span>
              <span className="hero-title-slogan">
                صورة أوضح. تجربة أهدأ. خطوة طبية بثقة أكبر.
              </span>
            </h1>
            <p className="hero-lead">
              مركز أشعة وتصوير طبي في حي المربع بالرياض، يجمع بين جودة الصورة،
              وضوح خطوات الفحص، والاهتمام براحتك وخصوصيتك. نساعدك من تأكيد الموعد
              وتعليمات التحضير حتى اكتمال تجربة الفحص بصورة منظمة ومطمئنة.
            </p>
