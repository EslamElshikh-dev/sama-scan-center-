...
`whatsapp_form_open` بعد التحقق من نموذج طلب التواصل وفتح واتساب. يحتفظ المتتبع
بمصدر دخول الجلسة ويفصل بين ملف Google التجاري، البحث الطبيعي، الإعلانات،
الإحالات والزيارات المباشرة. لا يُعد فتح واتساب حجزًا مؤكدًا، ولا تُرسل أسماء
المراجعين أو أرقامهم أو تفاصيلهم الطبية إلى أداة التحليلات.
